...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="HollowStoneMind Pretraining")
    ...
    parser.add_argument(
        ...
        help="tokenizer路径；必须指向一个可被AutoTokenizer.from_pretrained加载的目录",
    )
    parser.add_argument(
        "--from_weight",
        default="none",
    ...
    parser.add_argument(
        "--wandb_project", type=str, default="HollowStoneMind-Pretrain", help="wandb项目名"
    )
    ...
    if args.use_wandb and is_main_process():
        ...
        # 构建实验名称，包含关键超参数
        wandb_run_name = f"HollowStoneMind-Pretrain-Epoch-{args.epochs}-BatchSize-{args.batch_size}-LearningRate-{args.learning_rate}"
        wandb.init(
